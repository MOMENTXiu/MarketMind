...
> 本文档是 MarketMind 项目文档的总入口，分为三个 Part：
...
入门阅读顺序：README → ARCHITECTURE → 按需深读。
...
| 文档 | 说明 |
| --- | --- |
| [admin/admin-console-design.md](admin/admin-console-design.md) | Admin Console 设计文档：模块说明、API 契约、安全模型、部署步骤 |
| [admin/admin-ux-audit.md](admin/admin-ux-audit.md) | Admin Console UX 审查报告：风格一致性分析与修复记录 |
...
| [architecture/project-script-split-checklist.md](architecture/project-script-split-checklist.md) | 脚本拆实施清单 |
...
| [archive/data-processing-project-entry-design.md]() | *(缺失)* |
