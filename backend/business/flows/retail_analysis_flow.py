...
class RetailAnalysisFlow:
    ...
    def create_project(
        ...
        state = {
            ...
            "status": "queued",
            "stage_statuses": [new_stage(s) for s in (dp_stage_names if is_dp else STAGE_NAMES)],
    ...
    def get_dataset_ref(
        self, project_id: str, dataset_id: str, user_context: AuthenticatedUserContext | None = None
    ) -> dict[str, Any]:
        state = self._load_state(project_id, user_context)
