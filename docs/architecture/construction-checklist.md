...
- WHERE: `backend/business/flows/retail_analysis_flow.py`, `backend/providers/analysis_model_store_provider.py`, `backend/infrastructure/adapters/local_analysis_model_store_adapter.py`, `frontend/src/views/ProjectDetail.vue`, `frontend/src/views/DataProcessing.vue`, `docs/archive/postgres-redis-docker-migration-plan.md`, `docs/archive/analysis-v2-integration-checklist.md`, `docs/ARCHITECTURE.md`, `backend/README.md`, `README.md`, `AGENTS.md`.
